...
We’re excited to launch the ability to [lock time periods](/cms_trial/space/7TFJ/2183954434/Lock+time+periods/) in 7pace Timetracker for Jira!

This feature allows admins to lock time periods for editing, ensuring that time-tracking data remains accurate and reliable. This feature is handy when admins generate reports at the end of a reporting period and want to prevent any adjustments from being made.

With this release, 7pace Timetracker admins can lock time periods to prevent edits, helping ensure time-tracking data stays accurate and audit-ready. With this feature, you can create time schedules once and then lock time across all views. Need to make changes? Admins can unlock periods at any time for added flexibility.

Watch the video below to see it in action, or [read the full documentation](/cms_trial/space/7TFJ/2183954434/Lock+time+periods/) to get started.
