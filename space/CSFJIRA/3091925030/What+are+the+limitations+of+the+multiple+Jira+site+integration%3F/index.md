# What are the limitations of the multiple Jira site integration?

- The **Issue Comment** Component **(Aura/VisualForce)** will only be able to display the **default** connection’s issues.
- The **"Auto-create"** and **"Auto-associate*****"*** only work for the **default connection**. **"Auto-push"** will push to all connections.
