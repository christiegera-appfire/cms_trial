# Set up multiple Jira site integration

Connector for Salesforce & Jira provides customers the ability to sync data across Salesforce and Jira. With this feature, you will be able to achieve the following:

- Allow users to integrate multiple Jira instances into one Salesforce instance.
- Unblock multiple Jira teams (from different companies, etc.) in different Jira instances to work with the Salesforce team.

## Multiple Jira site integration content
