...
- Chatter posts now display correctly in the Legacy Lightning component.
- Fixed an issue where enabling the **Chatter Feed** option could cause duplicate comments to appear.
