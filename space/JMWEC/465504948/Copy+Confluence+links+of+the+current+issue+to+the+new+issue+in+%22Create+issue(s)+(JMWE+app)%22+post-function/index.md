...
This article explains how to copy remote Confluence links ofthe current issue to the new issue in [Create issue(s) (JMWE app)](/cms_trial/space/JMWEC/466256916/Create+issue(s)/) post-function, using [callJira](/cms_trial/space/JMWEC/465243039/callJira/) filter.
...
5. Enter the required details:  
   ...
   ```java
   {% for link in issue | remoteLinks | filter(["application.type","com.atlassian.confluence"]) %}
...
![JMWE for Jira Cloud create issues post function with Confluence link copying settings](/cms_trial/assets/9c566c11-bc39-4ca3-aaaa-428d3cd576aa.png)
