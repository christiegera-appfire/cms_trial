...
![JMWE for Jira Cloud scheduled actions administration with action management tools](/cms_trial/assets/49ab0f9a-2783-41e0-90d3-2ab86daed470.png)
...
- **Shared action list** - A list of all Scheduled Actions for the instance. The list includes the following information:
  ...
  - **Action menu** - Click to open a menu with specific actions for the Scheduled Action:
    ...
    - **ID** - The Jira ID of the Scheduled Action. Click the menu option to copy the ID value to your clipboard. This value can be used in the [JMWE Logs](/cms_trial/space/JMWEC/466321741/JMWE+Logs/) page to filter the logs by **Action ID**.
    - **Delete** - Permanently delete the Scheduled Action.

![JMWE for Jira Cloud scheduled action summary interface with action overview](/cms_trial/assets/0163c04a-6282-4c65-a2eb-b4b7080c140d.png)
...
![Scheduled Action Editor configuration screen](/cms_trial/assets/a2de5a3a-d937-4f4c-b0df-bf9f8ae5775c.png)
...
2. **Hour** and/or **Minute** - *All increments allow for the Scheduled Action to run at a specific time of day.*
   ...
   2. Multiple hours or minute values can be selected. For example, to run an action every day at 6 AM and 3 PM every day, set the field as pictured below.
      ...
      ![JMWE for Jira Cloud scheduled action time configuration with hour settings](/cms_trial/assets/95d5feaf-445f-4ba9-8a2d-b2f81b96bcd6.png)
...
![Scheduled Action Target Issues configuration screen](/cms_trial/assets/a02a2cba-8bca-46d4-b581-101b30c3ac85.png)
...
![JMWE for Jira Cloud scheduled action post functions configuration panel](/cms_trial/assets/f5299732-8cdc-4205-a1d3-a616e120daea.png)
...
![JMWE for Jira Cloud scheduled action post functions in simple view mode](/cms_trial/assets/14a9937b-b2c4-4ce1-b0da-9e3c54126ed5.png)![JMWE for Jira Cloud scheduled action post functions in advanced view mode](/cms_trial/assets/384ddce8-66a0-47eb-998c-469b9bea2d29.png)
