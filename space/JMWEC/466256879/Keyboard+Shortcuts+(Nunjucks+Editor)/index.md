...
| `delGroupBefore` | Delete to the left of the [group](http://appfire.atlassian.net/wiki/pages/resumedraft.action?draftId=78480623) before the cursor. | `Ctrl-Backspace` | `Alt-Backspace` |
