...
The **Transition Count** custom field is a calculated field that displays the number of times an issue has been moved through a specified workflow transition. It is a number field and is read-only.
...
## Configure a new ‘Transition Count’ field
...
**Note**: The `*ANY` value can cause unintended count values:

- If you leave the value `*ANY` in the **Transition From Status** field, all transitions *into a status value selected for* ***To Status*** *will be counted.*
- If you leave the value `*ANY` in the **To Status** field, all transitions *out of a status value selected for* ***Transition From Status*** *will be counted.*

You are viewing the documentation for **Jira Cloud**.

![Transition Count Screen](/cms_trial/assets/6ed461c2-36fd-4a0a-a785-da5c20482175.png)
