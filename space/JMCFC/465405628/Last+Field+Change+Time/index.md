...
The **Last Field Change Time** custom field is a calculated field that displays the date and time of the last change for the field it is configured to watch. It is a read-only field.
...
## Configure a new ‘Last Field Change Time’ field
...
Switch to [**Jira Server/Data Center**](https://appfire.atlassian.net/wiki/spaces/JMCF/pages/465862931).

### On This Page

Image — asset pipeline pending  
Last Field Change Time Screen
