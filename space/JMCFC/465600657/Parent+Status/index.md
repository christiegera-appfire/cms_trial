...
The **Parent Status** custom field is a calculated field that displays the status of the issues’s parent issue (if any). It is a read-only field.
...
## Configure a new ‘Parent Status’ field
...
2. Click **Next**.
3. There are no configuration options for this custom field type.
4. Click **Save**.

You are viewing the documentation for **Jira Cloud**.

![Parent Status Screen](/cms_trial/assets/266f2449-d8cf-4201-91cb-d3c48db44cde.png)
