...
Email notifications were not functioning correctly and have now been restored. All notification emails should be delivered as expected.

**Please note:** The email sender has temporarily changed to **GitPrime** instead of **7pace**. This is a temporary measure, and the sender will be changed in a future update. No action is required on your part — the emails are legitimate and can be trusted.
