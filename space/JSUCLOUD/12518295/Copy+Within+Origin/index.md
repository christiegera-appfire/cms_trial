...
Use the Copy Within Origin sub-function with the Create a Linked Issue post function to copy a value from a source field to a destination field within the origin issue. You can add any number of Copy Within Origin configurations.

## Configuration

![contentId-12518295](/cms_trial/assets/1cfbc998-526b-442d-8b20-a4ec055977e2.png)
