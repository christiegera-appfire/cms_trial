...
This release note covers JSU Cloud version `4.8.0`.

---

## Improvements

We updated the Issue relation selector in the Related Issue Status condition and validator. Now, issue relations are grouped by type: Parent/subtask, Epic/child, and Links. The issue relation options are:

- Parent of the subtask in transition
- Subtask of the parent issue in transition
- Epic of the child issue in transition
- Child of the epic in transition
- Linked to the issue in transition
