...
![Screenshot of the Permissions page in the OKR module.](/cms_trial/assets/6ba3ab72-2f64-44ce-9567-ae8a554b651f.png)
...
| **Advanced setup** | This option lets you define permissions for specific users or groups, create custom roles, and use OKR ownership-based roles to ensure alignment with the OKR process.  Visit [OKR advanced permissions](/cms_trial/space/SPM/1918767695/OKR+module+advanced+permissions/) to learn more. |
