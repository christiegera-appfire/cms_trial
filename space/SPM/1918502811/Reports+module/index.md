...
## Reports module (old navigation)

Click to expand the guide

## About the Reports module

With the **Reports module**, you can generate various reports to provide you with the data necessary for the project management process.

![contentId-1918502811](/cms_trial/assets/50e93d50-518c-4098-bdaf-050094b25b3b.png)

## Main features

Visit the [Report configuration](/cms_trial/space/SPM/1918766118/Report+configuration/) page to learn how to add reports to the dashboard and customize them.

The table presents a list of available actions and reports that can be generated.
...
| **Actions** | **Description** |
| Report configuration | You can add, edit, and delete reports. |
| Presentation view | The presentation view (called Lightbox) is a perfect tool to present charts to your audience. |

## Constraints

You **cannot** see a report if it includes tasks you cannot access.

## Reports module (new navigation)
...
![Screenshot of the Reports module in BigPicture.](/cms_trial/assets/0a36ef4a-74ed-4e82-ab89-9753708da194.png)
