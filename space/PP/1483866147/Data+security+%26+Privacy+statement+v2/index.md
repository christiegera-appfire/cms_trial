# Data security & Privacy statement v2

**WARNING: This document is outdated**.

See [Data Security and Privacy Statement v.3](/cms_trial/space/PP/9568600/Data+security+%26+Privacy+statement+v3/) instead (effective since July 27, 2024).

[List of changes in Data Security and Privacy Statement: v2 to v3](/cms_trial/space/PP/1483767830/List+of+changes+in+Data+security+%26+Privacy+statement+(v2+to+v3)/) describes changes between two versions of this statement.

## Introduction

This Privacy Policy supplements the [Appfire Privacy Policy](https://appfire.com/privacy-policy/) and explains what information Appfire Technologies, LLC ("Vendor") collects about you and why, what we do with that information, and how we handle the content you place in Planning Poker ("Add-On").   In the event of a conflict between the terms of this Privacy Policy and the Appfire Privacy Policy, the terms of this Privacy Policy shall control.
...
- Jira host details (as prescribed by the [Atlassian Connect Guidelines](https://developer.atlassian.com/static/connect/docs/latest/concepts/authentication.html))
...
As of the date this policy went into effect, we use Google Analytics and <http://keen.io> as analytics providers. To learn more about the privacy policy of Google Analytics, refer to [Google's Policies and Principles](https://www.google.com/policies/). Use the [Google Analytics Opt-out Browser](https://tools.google.com/dlpage/gaoptout?hl=en) App to prevent analytics information from being sent to Google Analytics. To learn more about the privacy policy of <http://keen.io> , refer to [keen.io Privacy Policy](https://keen.io/privacy-policy/).
...
- [Google Cloud Platform](https://cloud.google.com/gcp) - Cloud services provider
- [MongoDB Atlas](https://www.mongodb.com/atlas) - Cloud Database storage
- [Sendgrid](https://sendgrid.com/en-us) — For sending transactional emails
- [Google Analytics](https://analytics.google.com) — For collecting analytics
- [Keen.io](https://keen.io/) - For collecting analytics
...
The App hosts data with hosting service providers in numerous countries. The servers on which Personal Information is stored are kept in a controlled environment. While we take reasonable efforts to guard your Personal Information, no security system is impenetrable and due to the inherent nature of the Internet as an open global communications vehicle, we cannot guarantee that information, during transmission through the Internet or while stored on our systems or otherwise in our care, will be absolutely safe from intrusion by others, such as hackers. In addition, we cannot guarantee that any incidentally-collected Personal Information you choose to store in the App is maintained at levels of protection to meet specific needs or obligations you may have relating to that information.
...
The API services are hosted in Google Cloud Platform. Data is stored in MongoDB Atlas service with Google Cloud Platform as the actual storage. Data is stored in MongoDB Atlas service with Google Cloud Platform as the actual storage.
...
![contentId-1483866147](/cms_trial/assets/538ee220-ac24-4574-beb9-8a7037d7bb5e.jpg)
...
![contentId-1483866147](/cms_trial/assets/1e236e6a-89c6-456a-833c-e4b77b89915a.jpg)