# Release notes 26 February 2026
...
The following are the hotfixes in this release:

- We fixed an issue that started happening after the release of the **Exceptions** feature where creating a new calendar unintentionally deleted shared holidays from existing calendars. Now, when you create a new calendar, all shared holidays in your current calendars remain unchanged and intact.
