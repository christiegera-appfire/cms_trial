...
We've significantly boosted background report generation speeds by overhauling our backend architecture. Enjoy lightning-quick reports and spend more time analyzing results.
...
- Fixed an issue preventing SLAs from appearing on reports when using the Dynamic Calendar custom field.
...
A heartfelt thank you to our valued customers! Your incredible support and feedback inspire us to improve our apps and products continually. You are the driving force behind why we create software. We appreciate your trust in Time to SLA!
