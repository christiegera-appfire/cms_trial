...
- Resolved an issue where JQL validation was timing out on the SLA configuration page. Configurations should now load and validate more reliably.
- Fixed a display issue where some fields were not appearing correctly in the SLA Configuration view and edit screens. The layout and visibility are now consistent across different configurations.
- Addressed a problem where the recalculation history was not displaying the most recent data. Users can now view complete and up-to-date history logs.
