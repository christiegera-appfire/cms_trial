...
- Fixed an issue where SLAs using a Dynamic Calendar didn’t start as expected. The SLA start condition now works correctly when a dynamic calendar field is selected.
