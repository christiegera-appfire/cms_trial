...
- Resolved an issue that caused Jira Cloud Migration Assistant (JCMA) migrations to fail when migrating SLA configurations that included a Dynamic Duration Field from Time to SLA Data Center version 11.7.1 and later.
