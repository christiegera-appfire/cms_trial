...
For comprehensive details about SIL language syntax, data types, operators, and other language-specific elements, see the [SIL reference guide](https://appfire.atlassian.net/wiki/spaces/PSJC/pages/1934458884). The reference guide provides complete technical documentation for the language itself, while this section will help you apply SIL effectively in real-world scenarios.
