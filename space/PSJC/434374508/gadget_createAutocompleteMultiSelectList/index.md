...
|  |  |  |  |
| --- | --- | --- | --- |
| **Syntax** | gadget\_createAutocompleteMultiSelectList(label, options, defaultValue[, isRequired, fieldDescription]) | **Package** |  |
| **Alias** |  | **Pkg Usage** |  |
...
gadget_createAutocompleteMultiSelectList("Select list", {"C/C++", "Java", "Python", "Ruby"}, {"Java"}, true, "Choose one ore more");
```
