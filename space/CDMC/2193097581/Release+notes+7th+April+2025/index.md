...
Resolved an issue where instances upgraded to **CDM version 4.0.0** from the Marketplace could not send email notifications. A new version has been deployed to the Marketplace to restore this functionality. Affected customers should upgrade to the latest version to re-enable email notifications.
