...
- **Fix in Document Report:** Workflow states were incorrectly marked as **Obsolete** in some spaces that use a unique Space Workflow. This issue has now been resolved.
