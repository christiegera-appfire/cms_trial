...
- Resolved an issue where a saved Extended Search filter was not rendered with double quotation marks when opened in Jira Search.
- Vulnerability fixes.
